...
public class TestS3TC_and_ATI_lwjgl{
	public static void main(String[] _args) throws Exception {
		...
		CLI109.main(args);	
		args=("--debug --use_lwjgl --gen-mipmaps --format S3TC_DXT3 "
